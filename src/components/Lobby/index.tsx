...
export default function Lobby() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-900 p-6">
      ...
      <main className="flex-1 flex items-center justify-center gap-8 flex-wrap">
        ...
        <div className="bg-gray-800 p-8 rounded-3xl w-full max-w-sm border border-gray-700">
          ...
          <div className="flex gap-2">
            ...
            />
            <button onClick={handleJoinPrivate} className="bg-gray-700 hover:bg-gray-600 text-white font-bold py-3 px-6 rounded-xl transition">
              Join
            </button>
          </div>
        </div>
